                                    ...
                                    <div class="table-responsive">
                                        <table id="feedTable" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="personalDiscount" name="personalDiscount" readonly
                                                           class="form-control" value="${sessionScope.user.personalDiscount}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="#popupDeposit" style="alignment: center;">
