                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <form action="/mainController" method="post">
                                            ...
                                            <button class="btn btn-outline-primary btn-round">
                                                <fmt:message
                                                        key="buy_trainings.buyFor"/> ${(100 - user.personalDiscount)/100*5*20}
                                                <fmt:message key="buy_trainings.br"/>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <form action="/mainController" method="post">
                                            ...
                                            <button class="btn btn-outline-primary btn-round" type="submit">
                                                <fmt:message
                                                        key="buy_trainings.buyFor"/> ${(100 - user.personalDiscount)/100*10*20}
                                                <fmt:message key="buy_trainings.br"/>
                                            </button>
                                        </form>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <form action="/mainController" method="post">
                                            ...
                                            <button class="btn btn-outline-primary btn-round">
                                                <fmt:message
                                                        key="buy_trainings.buyFor"/> ${(100 - user.personalDiscount)/100*20*20}
                                                <fmt:message key="buy_trainings.br"/>
                                            </button>
                                        </form>
                                    </div>
