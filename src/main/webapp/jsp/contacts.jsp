            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="contact-info">
                        <i class="ti-email"></i>
                        <ul>
                            <li><span><fmt:message key="contacts.phoneLabel"/></span> <fmt:message key="contacts.phone"/></li>
                ...
                <div class="col-lg-4">
                    <div class="contact-info">
                        <i class="ti-timer"></i>
                        <ul>
                            <li><span><fmt:message key="contacts.workTimeLabel"/></span> <fmt:message key="contacts.workTime"/></li>
