                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="login" name="login" readonly
                                                           class="form-control" value="${sessionScope.user.account.name}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="email" id="phone" name="email" required
                                                           class="form-control" value="${sessionScope.user.account.email}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${incorrectEmailFormat==true}">
                                                        <label style="color: red; font-size: medium"><fmt:message key="personal_profile.incorrectEmailFormat"/></label>
                                                    </c:if>
                                                </td>
                                            </tr>
                                            </tbody>
