                                        ...
                                        <table id="feedTable" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${errorSet.contains(ValidationError.CHANGE_EMAIL_EXISTS)}">
                                                        <label style="color: red; font-size: medium;"><fmt:message
                                                                key="login.emailExists"/></label>
                                                        <customtags:flusher
                                                                error="${ValidationError.CHANGE_EMAIL_EXISTS}"/>
                                                    </c:if>
                                            ...
                                            <tr>
                                                <td>
                                                    <fmt:message key="personal_profile.newPassword"/>
                                                </td>
                                                <td>
                                                    <input type="password" id="newPassword" name="newPassword"
                                                           class="form-control" pattern="[a-zA-Z0-9_]{5,30}"
                                                           onchange="form.repeatNewPassword.pattern = this.value; this.setCustomValidity('')"
                                            ...
                                            <tr>
                                                <td>
                                                    <fmt:message key="personal_profile.repeatPassword"/>
                                                </td>
                                                <td>
                                                    <input type="password" id="repeatNewPassword"
                                                           name="repeatNewPassword" class="form-control"
