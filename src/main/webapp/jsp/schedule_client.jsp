...
<jsp:include page="${pageContext.request.contextPath}/jsp/modal/buy_trainings.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/jsp/modal/add_training.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/jsp/modal/edit_training.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/jsp/modal/rating.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/jsp/modal/low_balance.jsp"/>
