				...
				<div class="card">
					<div class="card-header card-header-primary">
						...
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#bookedTab"><fmt:message key="schedule_trainer.booked"/></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#doneTab"><fmt:message key="schedule_trainer.previous"/></a>
							</li>
						</ul>
					</div>
					<div class="card-body">
