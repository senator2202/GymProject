        ...
        <div class="nav-menu">
            <nav class="mainmenu mobile-menu">
                <ul>
                    ...
                    <li>
                        <a href="${(sessionScope.user!=null) ? '/mainController?command=logout"' : '/mainController?command=open_page&page=login"'}" class="primary-btn">
            ...
            <div class="col-lg-6">
                <div class="section-title">
                    ...
                    <p>Our fitness experts can help you discover new training
                        techniques and exercises that offer a
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-title">
                            <h2>Our Class</h2>
                            <p>Our fitness experts can help you discover new
                                training techniques and exercises that
                                offer a dynamic and efficient full-body
                                workout.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="class-item">
                            <div class="tab-content">
                                            ...
                                            <div class="col-lg-5 offset-lg-1">
                                                <div class="class-text">
                                                    ...
                                                    <p>Body Building, the
                                                        ...
                                                        body, fast! Focusing
                                                        on low weight loads and
                                                        high repetition
                                                        movements, you'll
                                                        burn fat, gain strength
                                                        and quickly produce lean
                                                        body muscle
                                                        conditioning. All the
                                                        benefits of working with
                                                        weighs in one
                                                        action packed, highly
                                                        physical class. The
                                                        world’s fastest
                                                        way to get in shape.
                                                        Find your Lessmills
                                ...
                                <div class="tab-pane fade" id="class-2"
                                     role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <div class="tab-pane fade" id="class-3"
                                     role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <div class="tab-pane fade" id="class-4"
                                     role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <div class="tab-pane fade" id="class-5"
                                     role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
                                ...
                                <div class="tab-pane fade" id="class-6"
                                     role="tabpanel">
                                    <div class="single-class-item">
                                        <div class="row">
                                            <div class="col-lg-6">
            ...
            <div class="col-lg-4">
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        ...
                        <h5><a href="jsp/blog-details.jsp">The Greatist Team's
                            Favorite Leggings With Pockets</a></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        ...
                        <h5><a href="jsp/blog-details.jsp">Everything You Need
                            to Know Before Your First Indoor Cycling Class</a>
                        </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="latest-items">
                    ...
                    <div class="latest-text">
                        ...
                        <h5><a href="jsp/blog-details.jsp">Run Your Best Race
                            Ever with These 5 Tips for the Perfect Taper</a>
                        </h5>
                    </div>
                </div>
            </div>
